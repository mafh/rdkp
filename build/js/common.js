...
function freeze(type, state) {
    var body = $('body'),
        page = $('.page-wrap');
    if (state === true) {
        body.addClass(type + '-is-visible').css({
            'overflow': 'hidden',
        ...
        body.removeClass(type + '-is-visible').removeAttr('style');
...
$(function headerAnimationFunction() {
    ...
    var $bg = $headerEl.find('.js-header-bg');
    var $img = $headerEl.find('.js-header-img');
    var $gradient = $headerEl.find('.js-header-gradient');
...
var stickybitsInstance = stickybits('.js-sidemenu', {
